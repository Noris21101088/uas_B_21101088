function updatedata(){
    ...
    gh.open("POST","http://localhost/webproB-main/webproB-main/server/dtmkupdate.php");
    ...
    gh.onload = function(){
        ...
        setTimeout(()=>{
            window.location.href="http://localhost/webproB-main/webproB-main/client/index.php?p=mk";
        },5000);
    }
